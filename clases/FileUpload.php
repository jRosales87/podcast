...
class FileUpload {
    ...
    private $destino="./", $nombre="", $tamaño=1000000000000,$parametro,$extension,$error=false, $politica = self::RENOMBRAR;
//tipo, archivos
    ...
    public function upload(){
     ...
     /* if(count($this->parametro['name'])>=1){
          self::subirMulti($this->parametro);
      }*/
      ...
      private function cambiarArray($array){
        $files=array();
      ...
      static function subirMulti($parametro){
         $cambioArray = self::cambiarArray($parametro);
